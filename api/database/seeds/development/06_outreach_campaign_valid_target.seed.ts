...
exports.seed = (knex: Knex) => {
  ...
  const getTargetIdByName = (name: string) =>
  ...
  return knex('outreach_campaign_target')
    ...
    .insert([
      ...
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Community group') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Resident') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Local business') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Local media') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('National media') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Corporate') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Local authority – elected member') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Local authority – officer') },
      { outreach_type_id: getTypeIdByName('Community Housing Project'), outreach_campaign_target_type_id: getTargetIdByName('Energy Provider') },
