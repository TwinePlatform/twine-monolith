    ...
    .then(() =>
        NODE_ENV !== Environment.PRODUCTION
          ? require(path.join(basePath, '18_test_user.seed.js')).seed(knex)
              ...
              .then(() => require(path.join(basePath, '26_test_volunteer_project.seed.js')).seed(knex))
              .then(() => require(path.join(basePath, '27_test_volunteer_hours_log.seed.js')).seed(knex))
              .then(() => require(path.join(basePath, '28_test_volunteer_admin_code.seed.js')).seed(knex))
          : Promise.resolve()
    )
};
