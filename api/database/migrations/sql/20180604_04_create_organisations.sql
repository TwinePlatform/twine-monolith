...
CREATE TABLE funding_programme (
  ...
  CONSTRAINT funding_programme_to_funding_body_fk FOREIGN KEY (organisation_id) REFERENCES organisation ON DELETE CASCADE
);
...
CREATE TABLE funding_programme_community_business (
  ...
  CONSTRAINT funding_programme_community_business_to_community_business_fk FOREIGN KEY (organisation_id) REFERENCES organisation ON DELETE CASCADE
);
