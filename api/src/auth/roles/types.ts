...
type RolesInterface = {
  add: (a: { role: Role, userId: number, organisationId: number }) => Promise<QueryResponse>,
  remove: (a: { role: Role, userId: number, organisationId: number }) => Promise<QueryResponse>,
  move : (a: { to: Role, from: Role, userId: number, organisationId: number }) =>
    Promise<QueryResponse>,
  removeUserFromAll : (a: { userId: number, organisationId: number }) => Promise<QueryResponse []>,
