...
*/
	...
	angular.module('app.controllers').controller('EditMeetingController', function (
    ...
    $scope.meetingTypes = [];
		...
		*/
        ...
        $$api.meetingTypes.get().success(function (result) {
          ...
          var offlineMeeting =  $.grep($localStorage.offlineData.meetings, function(e){ return e.id === $scope.formData.id; });
